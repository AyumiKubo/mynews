        ...
        <div class="row justify-content-center">
            <div calss="col-md-8">
                <div class="login-box card">
                    <div class="login-header caed-header mx-auto">{{ __('messages.Login') }}</div>
                    ...
                    <div class="login-body card-body">
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <div class="form-group row">
                                <label for="password" cladd="col-md-4 col-form-label text-md-right">{{__('messages.Password') }}</label>
